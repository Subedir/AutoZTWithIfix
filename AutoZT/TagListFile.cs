...
/// <param name="obj"></param>
        ...
        public void ReadDataFromExcelToDataTable()
        {
            ...
            try
            {
                ...
                for (int i = 1; i <= TotalSheets; i++)
                {
                    ...
                    //lastCell = null;                    
                    //Excel.Range AllCells = worksheet.get_Range("C6", "F6");
                    //Excel.Range lastCell = null;
        ...
        public void SaveOPCDataTableToCsvFile(string absolutePathAndFileName, string channelName, string plcName)
        {
            ...
            foreach (DataRow setRow in opcTable.Rows)
            {
                ...
                Match mc = Regex.Match(setRow["OPC Item"].ToString(), regexPattern);
                setRow["Trend Data File"] = mc.ToString();

                // this section is used to convert the subcontroller file names form the tabs of the excel input sheet
                /*
